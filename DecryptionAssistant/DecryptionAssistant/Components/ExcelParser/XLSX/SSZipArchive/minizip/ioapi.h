...
voidpf   ccall_zopen64 OF((const zlib_filefunc64_32_def* pfilefunc,const void*filename,int mode));
...
#define ZOPEN64(filefunc,filename,mode)             (ccall_zopen64((&(filefunc)),(filename),(mode)))
